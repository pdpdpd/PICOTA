...
indarr=(HG01885 HG01556) #HG02810 HG00109 HG01885 HG01556 HG03833 HG00109
...
do
  ...
  do
      if [ ! -f ./chr${chrs}_${ind}.vcf.gz ]; then
        echo bcftools view -c1 -Oz -s ${ind} -v snps -o chr${chrs}_${ind}.vcf.gz chr${chrs}.vcf.gz
        bcftools view -c1 -Oz -s ${ind} -v snps -o chr${chrs}_${ind}.vcf.gz chr${chrs}.vcf.gz
      fi 
